...
public class CapyEntityGen {
  ...
  public static void addSpawn() {
    BiomeModifications.addSpawn(
        ...
        SpawnGroup.CREATURE, CapyEntities.CAPYBARA, 50, 3, 6);

    SpawnRestriction.register(CapyEntities.CAPYBARA, SpawnLocationTypes.ON_GROUND, Type.MOTION_BLOCKING_NO_LEAVES,
