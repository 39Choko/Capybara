...
public class DevMobModel extends GeoModel<DevMobEntity> {
   ...
   public Identifier getModelResource(DevMobEntity animatable) {
      return Register.registerLocation("dev_mob", "dev_mob.geo.json");
   }
   ...
   public Identifier getAnimationResource(DevMobEntity animatable) {
      return Register.registerLocation("dev_mob", "dev_mob.animation.json");
   }

   @Override
   public void setCustomAnimations(DevMobEntity animatable, long instanceId,
      ...
      if (head != null){
         ...
         head.setRotX(entityModelData.netHeadYaw() * MathHelper.RADIANS_PER_DEGREE);
      }
   }
